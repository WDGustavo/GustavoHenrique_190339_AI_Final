...
public class AI_Seek : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision col)
    {
        ...
        //caso colida em algo com a tag player
        if (col.collider.CompareTag("Player"))
        {
            //pega o componente do player
            var drive = col.collider.GetComponent<Drive>();
            //da instakill
            drive.Damege(100f);
        }
    }
    ...
    [Task]
    //metodo para fazer o estado de perseguir
    public void SeekPlayer()
    {
        //seta o destino para a posição do jogador
